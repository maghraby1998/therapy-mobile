  ...
  return (
    <ScreenShell>
      <View style={styles.container}>
        ...
        <Text style={styles.title}>A focused dashboard for care plans, notes, and availability.</Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>Today&apos;s appointments and patient summaries.</Text>
          <Text style={styles.cardText}>Availability management and consultation notes.</Text>
        </View>
      </View>
    </ScreenShell>
  );
